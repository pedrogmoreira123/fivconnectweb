...
function SocialIcon({ href, label, children }: { href: string; label: string; children: React.ReactNode }) {
  return (
    <a
      ...
      style={{ background: 'rgba(245,239,228,0.08)', color: 'rgba(245,239,228,0.5)' }}
      onMouseEnter={e => {
        ...
        <div className="py-16 grid grid-cols-2 md:grid-cols-5 gap-10">
          ...
          <div className="col-span-2">
            ...
            <div className="flex items-center gap-2">
              <SocialIcon href="https://www.instagram.com/fi.vconnect/" label="Instagram">
              ...
              <SocialIcon href="https://wa.me/5511944745067" label="WhatsApp">
                <svg viewBox="0 0 24 24" width="15" height="15" fill="currentColor">
              ...
              <SocialIcon href="mailto:contato@fivconnect.net" label="E-mail">
